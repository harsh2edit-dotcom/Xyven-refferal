...
CREATE INDEX idx_refs_referrer ON referrals(referrer_id, status);
...
-- Seed test coupons
INSERT INTO coupons (code, reward_paise, max_uses, per_user_limit, active)
VALUES
  ('WELCOME50', 5000, 0, 1, TRUE),
  ('XYVEN100', 10000, 100, 1, TRUE),
